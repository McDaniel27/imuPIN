...
# Calibrate sensor.
q = sensor_calibration.calibrate_by_time(ser, q, 2000, True, True)
...
graphing.plot_acceleration_graph(acceleration, 2)
graphing.plot_acceleration_graph(compressed, 2)
graphing.plot_acceleration_graph(discrete, 16)
